...
public class BMICalcA {
	...
	public static void main(String[] args) {
		...
		//Run the body mass index through an if statement to check if it is between 16 and 18.5
		if (bodyMassIndex<18.5 && bodyMassIndex>=16){

			System.out.println("\nYour Body Mass Index(BMI) is " + bodyMassIndex);
			System.out.println("You should consult a doctor immediately, you are underweight!\n\nThank you for using the BMI Calculator!");
		}

		//Run the body mass index through an if statement to check if it is between 18.5 and 25
		...
		//Run the body mass index through an if statement to check if it is between 30 and 25
		if (bodyMassIndex<30 && bodyMassIndex>=25){

			System.out.println("\nYour Body Mass Index(BMI) is " + bodyMassIndex);
			System.out.println("You should consult a doctor immediately, you are overweight!\n\nThank you for using the BMI Calculator!");
		}

		//Run the body mass index through an if statement to check if it is between 35 and 30
		if (bodyMassIndex<35 && bodyMassIndex>=30){

			System.out.println("\nYour Body Mass Index(BMI) is " + bodyMassIndex);
			System.out.println("You should consult a doctor immediately, you are obese!\n\nThank you for using the BMI Calculator!");
		}

		//Run the body mass index through an if statement to check if it is above 35
		if (bodyMassIndex>=35){
